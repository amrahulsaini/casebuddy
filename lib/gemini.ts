...
export const ANGLE_DESCRIPTIONS = [
  'PANEL 1 - AMAZON HERO SHOT: TWO smartphones positioned side-by-side with SLIGHT OVERLAP on CLEAN WHITE BACKGROUND. Both phones at SLIGHT 3/4 ANGLE (approximately 15-20 degree tilt) showing depth. LEFT PHONE: Shows BACK VIEW with case at 3/4 angle - For DOYERS cases: BLACK FRAME/BUMPER clearly wrapping all edges with sharp definition, TRANSPARENT CENTER PANEL showing actual phone color/body and branding (like "vivo" logo visible through clear center). CRITICAL CAMERA ACCURACY: The camera module cutout in the BLACK FRAME must EXACTLY match the specified phone model\'s precise camera configuration - analyze the phone model name provided (e.g., "Vivo V60 5G", "Galaxy A35 5G") and render the EXACT number of camera lenses, their EXACT positions (vertical/horizontal/diagonal arrangement), EXACT sizes (main/ultra-wide/macro/depth), and EXACT spacing as that specific phone model has in reality. DO NOT use generic camera layouts. Research and replicate the actual camera island shape and lens configuration of the named phone model. The camera cutout must be a precise match to that model\'s specifications. RIGHT PHONE: Shows FRONT DISPLAY/SCREEN at matching slight 3/4 angle with screen facing viewer, displaying phone model compatibility text clearly readable. Both phones in upright position at IDENTICAL SLIGHT TILT ANGLE (15-20 degrees), slightly overlapping at edges, CENTERED in frame. Professional Amazon-style e-commerce studio lighting with soft shadows beneath phones. Clean white background with subtle gradient. This is the main Amazon product hero image showing complete 360° view - case design on left, screen functionality on right. For DOYERS cases: Show strong contrast between matte black protective frame edges and crystal-clear transparent center where phone body is visible. The black frame should have sharp, clean boundaries. TRANSPARENT cases: Show full phone visibility through clear material. BLACK cases: Show solid black protective coverage. Material accuracy and phone-specific camera precision are MANDATORY. Clean, minimal, professional product photography. Both phones ALWAYS at this consistent slight 3/4 tilt angle.',
