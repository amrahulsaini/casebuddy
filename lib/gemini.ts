...
export const ANGLE_DESCRIPTIONS: Record<string, string[]> = {
  ...
  matte: [
    'PANEL 1 (Pure White Background): EXACT empty case from reference tilted at 45-degree angle on a white pedestal. CRITICAL: PRESERVE EXACT COLORS from reference - SAME frame color, SAME transparency level, SAME materials, SAME design. DO NOT CHANGE ANY COLORS. Copy colors pixel-perfect from reference image. NO phone inside. Style: PNG CUTOUT / CLIPPING PATH STYLE with visible pedestal. 🚫 NO AMBIENT OCCLUSION 🚫 🚫 NO CONTACT SHADOWS 🚫 🚫 NO DROP SHADOWS 🚫. Pure RGB 255,255,255 white background. Pedestal visible but casts zero shadows. Completely flat white background with no gradients or dark areas. Match reference colors EXACTLY.',
    
    'PANEL 2 (Pure White Background): EXACT empty case from reference image standing upright on a white pedestal - back view only showing camera cutouts. CRITICAL: PRESERVE EXACT COLORS from reference - SAME frame color, SAME transparency level, SAME materials, SAME design. DO NOT CHANGE ANY COLORS. Copy colors pixel-perfect from reference image. Show ONLY the back view displaying camera cutout design clearly. NO phone inside. NO hand. Style: PNG CUTOUT / CLIPPING PATH STYLE with visible pedestal. 🚫 NO AMBIENT OCCLUSION 🚫 🚫 NO CONTACT SHADOWS 🚫 🚫 NO DROP SHADOWS 🚫. Pure RGB 255,255,255 white background. Pedestal visible but casts zero shadows. Completely flat white background with no gradients or dark areas. Match reference colors EXACTLY.',
  ],
};
