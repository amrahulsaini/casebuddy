...
export const ANGLE_DESCRIPTIONS = [
  ...
  'PANEL 3 - HYBRID DESIGN 3D RENDER: SINGLE phone case displayed in DRAMATIC CURVED/BENT POSITION floating in 3D space on LIGHT GRADIENT BACKGROUND (white to light grey/blue). Case is SIGNIFICANTLY CURVED and BENT like a wave or S-curve showing flexibility and three-dimensional form. The case appears to be twisting/bending through space demonstrating the flexible hybrid construction. Shows BACK VIEW with BLACK SOFT TPU EDGES clearly visible on the outer frame and TRANSPARENT CRYSTAL CLEAR PC BACKPLANE in the center. Camera cutouts visible matching the actual phone model\'s exact camera configuration based on provided phone model name. Large bold text "Hybrid Design" positioned at TOP-RIGHT of image in modern clean font. Two annotation labels with DOTTED LINES pointing to specific parts: 1) Label "Tough PC backplane" with dotted line pointing to the transparent center area, 2) Label "Soft TPU edge" with dotted line pointing to the black flexible frame edges. Decorative CIRCULAR ELEMENTS (spheres/bubbles) in corners of image in light grey/blue tones adding modern aesthetic. Soft shadows beneath the curved case. The case should appear dramatically bent/curved showing both the rigid transparent back and flexible black edges in a dynamic S-curve or wave position. Professional 3D product render style with clean minimalist design. Light, airy background.',
