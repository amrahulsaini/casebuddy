...
export const ANGLE_DESCRIPTIONS: Record<string, string[]> = {
  ...
  matte: [
    ...
    'GRID 3 (Pure White Background): EXACT empty case from reference in tilted pose FLOATING in space. NO PEDESTAL VISIBLE. Preserve ALL original colors, transparency, materials. NO phone inside. 🚫 ZERO SHADOWS - NONE AT ALL 🚫. High-key lighting setup. Pure white seamless infinity background. Case appears to FLOAT with NO ground contact, NO shadow underneath, NO shadow behind. Completely shadowless like professional product cutout. DO NOT alter case appearance.',
    
    'GRID 4 (Pure White Background): EXACT empty case from reference image - back view only FLOATING in space. NO PEDESTAL VISIBLE. Show ONLY the back view displaying camera cutouts and design. Preserve ALL original colors, patterns, materials, transparency from reference. NO phone inside. NO hand. 🚫 ZERO SHADOWS - NONE AT ALL 🚫. High-key lighting setup. Pure white seamless infinity background. Case appears to FLOAT with NO ground contact, NO shadow underneath, NO shadow behind. Completely shadowless like professional product cutout.',
  ],
};
