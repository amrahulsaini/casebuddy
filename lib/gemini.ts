...
export const ANGLE_DESCRIPTIONS: Record<string, string[]> = {
  ...
  matte: [
    'PANEL 1 (Pure White Background): EXACT empty case from reference tilted at 45-degree angle on a white pedestal. Pedestal is VISIBLE but has NO shadow. Preserve ALL original colors, transparency, materials from reference. NO phone inside. 🚫 ABSOLUTELY NO SHADOWS ANYWHERE 🚫 - NO shadows where case touches pedestal, NO shadows underneath pedestal, NO shadows behind case, NO dark areas at all. Use OVEREXPOSED high-key studio lighting that completely washes out all shadows. Pure white seamless background. Pedestal blends into white background. Zero shadows in contact area between case and pedestal. Completely shadowless. DO NOT alter case appearance.',
    
    'PANEL 2 (Pure White Background): EXACT empty case from reference image standing upright on a white pedestal - back view only showing camera cutouts. Pedestal is VISIBLE but has NO shadow. Show ONLY the back view displaying camera cutout design clearly. Preserve ALL original colors, patterns, materials, transparency from reference. NO phone inside. NO hand. 🚫 ABSOLUTELY NO SHADOWS ANYWHERE 🚫 - NO shadows where case touches pedestal, NO shadows underneath pedestal, NO shadows behind case, NO dark areas at all. Use OVEREXPOSED high-key studio lighting that completely washes out all shadows. Pure white seamless background. Pedestal blends into white background. Zero shadows in contact area between case and pedestal. Completely shadowless.',
  ],
};
