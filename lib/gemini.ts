...
export const ANGLE_DESCRIPTIONS: Record<string, string[]> = {
  ...
  matte: [
    'PANEL 1 (Pure White Background): EXACT same case from reference image placed on white pedestal - tilted 45-degree angle view. Use EXACT SAME case design, colors, patterns, materials from reference photo. Just show it at tilted angle on pedestal. NO phone inside. CRITICAL: Pure white background with ZERO shadows - completely eliminate all shadows beneath case and pedestal using high-key lighting or digital removal. Flat lighting.',
    
    'PANEL 2 (Pure White Background): EXACT same case from reference image placed on white pedestal - back view showing camera cutouts. Use EXACT SAME case design, colors, patterns, materials from reference photo. Just show back side clearly on pedestal. NO phone inside. CRITICAL: Pure white background with ZERO shadows - completely eliminate all shadows beneath case and pedestal using high-key lighting or digital removal. Flat lighting.',
  ],
};
