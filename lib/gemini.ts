...
export const ANGLE_DESCRIPTIONS: Record<string, string[]> = {
  doyers: [
    'PANEL 1 (Soft pearl studio background, not harsh pure white): Premium Amazon-style ecommerce hero shot. Two identical phones arranged in a fanned-out V-shape composition exactly as seen in professional Amazon product listings — the two phones splay outward from a shared bottom-center vanishing point, each tilted 20–30 degrees away from vertical in opposite directions, overlapping slightly in the middle with one phone layered in front of the other. LEFT phone: positioned slightly in front (closer to viewer, higher z-depth), tilted to the right showing its BACK with the exact doyers case from reference fitted perfectly — the transparent center panel must reveal the authentic phone back finish beneath it, rear cameras correctly placed and matching researched specs. RIGHT phone: positioned slightly behind, tilted to the left showing its FRONT SCREEN with realistic front glass, correct punch-hole or notch position, correct bezel thickness, and a tasteful premium abstract wallpaper or subtle gradient lockscreen — never blank white or solid black. Both phones share the same identical phone model and case. Soft directional studio light from top-left with subtle drop shadows beneath each phone to give realistic depth and grounding. The overall silhouette of the two-phone composition should read as a clean symmetric fan — like flagship smartphone dual-view product shots on Amazon.in. No logos, no phone model text, no brand names anywhere.',
