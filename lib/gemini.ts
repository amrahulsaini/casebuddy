...
export const ANGLE_DESCRIPTIONS: Record<string, string[]> = {
  doyers: [
    'PANEL 1 — PURE WHITE BACKGROUND (#FFFFFF clean studio backdrop, same as Amazon product listings). Amazon-style premium dual-phone hero shot: two identical phones of the correct model standing upright and GROUNDED — bottom edges of both phones rest firmly on an invisible flat surface, never floating or suspended in air. Both phones lean slightly toward each other creating a natural fanned-out V-shape, overlapping in the center with the LEFT phone layered slightly in front of the RIGHT phone. LEFT phone (front/closer to viewer): tilted about 15 degrees to the right, showing the BACK of the phone with the exact doyers case from reference image fitted on — the black protective bumper frame wraps the edges, and the transparent/frosted center panel of the case MUST reveal the phone\'s ORIGINAL authentic body color underneath (preserve the real factory finish: if it is dark titanium, graphite, midnight black, deep blue, or any other color — show THAT exact color through the clear panel, NEVER white or grey placeholder). Rear cameras and flash correctly positioned per researched specs. RIGHT phone (slightly behind, partially overlapping left phone): tilted about 15 degrees to the left, showing the FRONT SCREEN with full-face display, correct Dynamic Island or punch-hole or notch matching the model, correct thin bezels, and a tasteful nature/gradient/abstract wallpaper on the screen — screen MUST look realistic and lit, never blank white or solid black. Both phones cast a soft subtle contact shadow straight below onto the surface, confirming they are standing and grounded. Clean soft-box studio lighting from slightly above. No logos, no phone model text, no brand text anywhere.',

    'PANEL 2 — PURE WHITE BACKGROUND (#FFFFFF clean studio backdrop). Two items displayed side by side, both standing upright and grounded with bottom edges resting on a flat surface. LEFT: the exact empty doyers case from reference standing alone — black bumper frame and transparent center panel clearly visible, case geometry, camera cutout shape, corner radius, and material finish all exactly matching the reference image; the clear panel must not merge with the white background (add faint edge shadow or slight separation). RIGHT: the same exact case with the correct phone model fully inserted — the phone body must be visible through the transparent center in its authentic original factory color (NEVER white or grey); cameras correctly placed per researched specs. Soft drop shadow beneath each item. No logos or phone model text anywhere.',

    'PANEL 3 — PURE WHITE BACKGROUND (#FFFFFF clean studio backdrop). Single straight-on BACK VIEW of the correct phone model inserted fully into the exact doyers case from reference, displayed upright and centered. The black bumper frame of the case wraps the phone edges precisely. The transparent center panel of the case MUST clearly reveal the phone\'s original authentic body color and finish (dark titanium, graphite, midnight, or the real factory color — NEVER generic white or grey filler). Rear cameras and flash are correctly positioned and match researched specs exactly. Soft drop shadow below the phone confirms it is grounded on the surface. Preserve all case colors, texture, and transparency from the reference. Camera configuration must match researched specs. No logos or phone model text anywhere.',

    'PANEL 4 — PURE WHITE BACKGROUND (#FFFFFF clean studio backdrop). A hand holding the phone naturally and comfortably — the phone (correct model) is inside the exact doyers case from reference. The black bumper frame is clearly visible on the edges. The transparent center panel of the case must show the phone\'s original authentic body color beneath (NEVER white or grey). Cameras and flash correctly placed per researched specs. The composition shows the back of the phone with the case, held at a natural product-photography angle. Add the text "Flaunt The Original Look" in clean minimal typography. No other logos, no phone model text, no brand names.',
  ],
