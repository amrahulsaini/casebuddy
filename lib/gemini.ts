...
export const ANGLE_DESCRIPTIONS: Record<string, string[]> = {
  ...
  matte: [
    'PANEL 1 (Pure White Background): EXACT empty case from reference tilted at 45-degree angle on invisible support. Preserve ALL original colors, transparency, materials from reference. NO phone inside. Style: PNG CUTOUT / CLIPPING PATH STYLE - like product isolated on white with shadows digitally removed. 🚫 NO AMBIENT OCCLUSION 🚫 🚫 NO CONTACT SHADOWS 🚫 🚫 NO DROP SHADOWS 🚫. Pure RGB 255,255,255 white background. Case appears SUSPENDED in air with zero shadow artifacts. Product photography with post-processed shadow removal. Completely flat white background with no gradients or dark areas. DO NOT alter case appearance.',
    
    'PANEL 2 (Pure White Background): EXACT empty case from reference image standing upright on invisible support - back view only showing camera cutouts. Show ONLY the back view displaying camera cutout design clearly. Preserve ALL original colors, patterns, materials, transparency from reference. NO phone inside. NO hand. Style: PNG CUTOUT / CLIPPING PATH STYLE - like product isolated on white with shadows digitally removed. 🚫 NO AMBIENT OCCLUSION 🚫 🚫 NO CONTACT SHADOWS 🚫 🚫 NO DROP SHADOWS 🚫. Pure RGB 255,255,255 white background. Case appears SUSPENDED in air with zero shadow artifacts. Product photography with post-processed shadow removal. Completely flat white background with no gradients or dark areas.',
  ],
};
